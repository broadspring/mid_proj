	...
	<c:forEach var="m" items="${msgs }">
		<table class="aSNSMsg">
			...
			<tr>
			 ...
			 <tr>
				<td class="asmReply"><c:forEach var="sr" items="${m.s_replys }">
						...
						<form action="sns.reply.write"
							...
							<span class="asmrOwner"> ${sessionScope.loginMember.m_id }
							</span> <input type="hidden" name="token" value="${token }"> <input
								type="hidden" name="r_s_no" value="${m.s_no }"> <input
								type="hidden" name="p" value="${curPage }"> <input
								class="asmrInput" name="r_txt" maxlength="80" autocomplete="off">
