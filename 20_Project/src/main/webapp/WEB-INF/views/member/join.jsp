...
<body>
	...
	<form action="member.join" method="post" enctype="multipart/form-data"
		...
		<table id="joinTable">
			...
			<tr>
				<td class="td1">ID</td>
				<td class="td2"><input id="jm_idInput" name="m_id"
					placeholder="필수, 영어/숫자만" maxlength="10" autocomplete="off"
					autofocus="autofocus"></td>
			</tr>
			<tr>
				<td class="td1">PW</td>
				<td class="td2"><input name="m_pw"
					placeholder="필수, 숫자 하나이상 반드시" type="password" maxlength="10"
					autocomplete="off"></td>
			</tr>
			<tr>
				<td class="td1">PW확인</td>
				<td class="td2"><input name="m_pwChk"
					placeholder="필수, 숫자 하나이상 반드시" type="password" maxlength="10"
					autocomplete="off"></td>
			</tr>
			<tr>
				<td class="td1">이름</td>
				<td class="td2"><input name="m_name" placeholder="필수"
					maxlength="10" autocomplete="off"></td>
			<tr>
				<td class="td1">주소</td>
				<td class="td2"><input id="jm_addr3Input" readonly="readonly"
					name="m_addr3" maxlength="5" autocomplete="off" placeholder="우편번호">
